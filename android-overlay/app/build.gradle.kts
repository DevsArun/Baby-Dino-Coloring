...
// Gradle configures ALL build types even for `assembleDebug`, so demanding
// key.properties unconditionally would break debug builds. Only fail loudly
// when a release task is actually requested without the keystore present.
